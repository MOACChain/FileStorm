...
import moac.ipfs.common.validator.Assert;
...
import moac.ipfs.modules.back.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R password(@RequestBody PasswordForm form){
		Assert.isBlank(form.getNewPassword(), "新密码不为能空", ErrorCodeConstant.PASSWORD_CANNOT_BE_EMPTY);
